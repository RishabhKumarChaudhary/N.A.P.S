...
<section class="section" style="padding: 0rem !important;">
    ...
    <div class="tile is-parent">
        <article class="tile is-child box is-12">
            <div class="level" style="justify-content:left !important">
                <div class="level-left">
                    <div class="level-item" style="margin-right: 2rem;">
                        <figure class="image">
                            <img class="is-rounded" src="Assets/img/team-ch.jpg">
                        </figure>
                    </div>
                </div>
                <div class="level-right">
                    <div class="level-item">
                        <div class="title is-3" style="font-family: cinzel;">
                            Dr. Charu Wahi
                        </div>
                    </div>
                </div>
        ...
        <article class="tile is-child box is-12">
            <div class="level" style="justify-content:left !important">
                <div class="level-left">
                    <div class="level-item" style="margin-right: 2rem;">
                        <figure class="image">
                            <img class="is-rounded" src="Assets/img/team-nm.jpeg">
                        </figure>
                    </div>
                </div>
                <div class="level-right">
            ...
            <div class="level-left">
                <div class="level-item"style="margin-right: 2rem;">
                    <figure class="image is-128x128">
                        <img class="is-rounded" src="Assets/img/team-rc.jpg">
                    </figure>
                </div>
            </div>
            <div class="level-right">
                <div class="level-item">
                <div class="title is-4" style="font-family: cinzel;">
                            Rishabh Chaudhary
                </div>
                </div>
            </div>
    ...
    <div class="tile is-parent">
        ...
        <div class="level" style="justify-content:left !important">
            <div class="level-left">
                <div class="level-item" style="margin-right: 2rem;">
                    <figure class="image is-128x128">
                        <img class="is-rounded" src="Assets/img/team-pr.jpg">
                    </figure>
                </div>
            </div>
            <div class="level-right">
