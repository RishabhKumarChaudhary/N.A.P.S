    ...
    <div class="hero">
        <div class="hero-body">
                ...
                <div class="level-left">
                    <div class="level-item">
                        <div class="subtitle is-5">
                            <strong>Posted On:</strong> <span style="color: red;">29-6-21</span>
                        </div>
                    </div>
                </div>
                <div class="level-right">
                    <div class="level-item is-align-left" >
                        <div class="subtitle is-5">
                            <strong>By:</strong> <span style="color: red;">Author Name</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns is-vcentered">
                ...
                <figure style="margin-left: 0rem;">
                <img class="image" src="https://bitmesra.ac.in/naps/wp-content/uploads/2021/03/simlipal-forest-fire.jpg">
                </figure>
                <p>
                ...
                livelihoods. <br>
                <blockquote> <i>1997, wildfires set intentionally to clear the grasslands in
                Indonesia intensified into one of the largest wildfires chronicled in history.</i>
                </blockquote>
