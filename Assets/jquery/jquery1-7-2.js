...
(function (a, b) {
    ...
    function bn(a) {
        ...
        b === "input"
            ? bm(a)
            : b !== "script" && typeof a.getElementsByTagName != "undefined" && f.grep(
    ...
    function n(a, b, c) {
        var d = b + "defer",
            ...
            g = b + "mark",
            h = f._data(a, d);
        h && (c === "queue" || !f._data(a, e)) && (c === "mark" || !f._data(a, g)) && setTimeout(
            function () {
            ...
            e.extend({
                ...
                map: function (a, c, d) {
                    var f,
                        ...
                        i = 0,
                        j = a.length,
                        k = a instanceof e || j !== b && typeof j == "number" && (
    ...
    f.support = function () {
        ...
        p.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>" +
    ...
    j.removeChild(p),
        ...
        f(function () {
            ...
            !u || (
                ...
                q = "<div " + n + "display:block;'><div style='" + t + "0;display:block;overflo" +
                        "w:hidden;'></div></div><table " + n + "' cellpadding='0' cellspacing='0'><tr><" +
                        "td></td></tr></table>",
                d = c.createElement("div"),
                d.style.cssText = s + "width:0;height:0;position:static;top:0;margin-top:" + m +
                        "px",
                u.insertBefore(d, u.firstChild),
                p = c.createElement("div"),
                d.appendChild(p),
                p.innerHTML = "<table><tr><td style='" + t + "0;display:none'></td><td>t</td></" +
                        "tr></table>",
        ...
        .extend({
            ...
            val: function (a) {
                    ...
                    g = this[0];
                {
                    if (!!arguments.length) {
                        ...
                        return this.each(function (d) {
                            ...
                            if (this.nodeType === 1) {
                                ...
                                c = f.valHooks[this.type] || f.valHooks[
                                    this
                                        .nodeName
                                        .toLowerCase()
                                ];
                    ...
                    if (g) {
                        c = f.valHooks[g.type] || f.valHooks[
                            g
                                .nodeName
                                .toLowerCase()
                        ];
            ...
            if (!!g && !!(o = g.events)) {
                ...
                for (h = 0; h < b.length; h++) {
                    ...
                    for (n = 0; n < r.length; n++) 
                        s = r[n],
                        (e || k === s.origType) && (!c || c.guid === s.guid) && (
        ...
        trigger: function (c, d, e, g) {
            if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
                ...
                if (!e) {
                    j = f.cache;
                    for (l in j) 
                        j[l].events && j[l].events[h] && f
                            .event
                            .trigger(c, d, j[l].handle.elem, !0);
                    return
                }
                c.result = b,
                c.target || (c.target = e),
    ...
    f.Event = function (a, b) {
        ...
        a && a.type
            ? (
                ...
                this.type = a.type,
                this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || a.getPreventDefault && a.getPreventDefault()
                    ? K
                    : J
            )
            : this.type = a,
                ...
                .add(this, "beforeactivate._change", function (a) {
                    ...
                    z.test(b.nodeName) && !b._change_attached && (
                        f.event.add(b, "change._change", function (a) {
                            this.parentNode && !a.isSimulated && !a.isTrigger && f
                                .event
    ...
    f.support.focusinBubbles || f.each({
        ...
        var d = 0,
            e = function (a) {
                f
                    .event
                    .simulate(b, a.target, f.event.fix(a), !0)
            };
        f
            .event
            .special[b] = {
        ...
        var m = function (b, d, e, f) {
            ...
            if (g.call(k) === "[object Array]") 
                if (!u) 
                    ...
                    for (t = 0; k[t] != null; t++) 
                        k[t] && (k[t] === !0 || k[t].nodeType === 1 && m.contains(d, k[t])) && e.push(
                            j[t]
                        );
        else 
                for (t = 0; k[t] != null; t++) 
            ...
            o = m.selectors = {
                ...
                filters: {
                    ...
                    radio: function (a) {
                        return a
                            .nodeName
                            .toLowerCase() === "input" && "radio" === a.type
                    },
                    checkbox: function (a) {
                        return a
                            .nodeName
                            .toLowerCase() === "input" && "checkbox" === a.type
                    },
                    file: function (a) {
                        return a
                            .nodeName
                            .toLowerCase() === "input" && "file" === a.type
                    },
                    password: function (a) {
                        return a
                            .nodeName
                            .toLowerCase() === "input" && "password" === a.type
                    },
                    submit: function (a) {
                        var b = a
                            .nodeName
                    ...
                    image: function (a) {
                        return a
                            .nodeName
                            .toLowerCase() === "input" && "image" === a.type
                    },
                    reset: function (a) {
                        var b = a
                            .nodeName
                ...
                filter: {
                    ...
                    TAG: function (a, b) {
                        return b === "*" && a.nodeType === 1 || !!a.nodeName && a
                            .nodeName
                            .toLowerCase() === b
                    },
                    CLASS: function (a, b) {
    ...
    f
        ...
        .extend({
            ...
            closest: function (a, b) {
                ...
                var i = Q.test(a) || typeof a != "string"
                    ? f(a, b || this.context)
                    : 0;
                for (d = 0, e = this.length; d < e; d++) {
                    g = this[d];
    ...
    var V = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|fo" +
    ...
    f.buildFragment = function (a, b, d) {
        ...
        a.length === 1 && typeof j == "string" && j.length < 512 && i === c && j.charAt(
            0
        ) === "<" && !bb.test(j) && (f.support.checkClone || !bd.test(j)) && (
    ...
    f.extend({
        clone: function (a, b, c) {
            var d,
                e,
                g,
                h = f.support.html5Clone || f.isXMLDoc(a) || !bc.test("<" + a.nodeName + ">")
                    ? a.cloneNode(!0)
                    : bo(a);
            ...
            for (var k = 0, l; (l = a[k]) != null; k++) {
                ...
                if (typeof l == "string") 
                    if (!_.test(l)) 
                        ...
                        !f.support.leadingWhitespace && X.test(l) && p.insertBefore(
                ...
                f.ajax({
                    ...
                    complete: function (a, b, c) {
                        ...
                        a.isResolved() && (a.done(function (a) {
                            ...
                            g
                                ? f("<div>").append(c.replace(bM, "")).find(g)
                                : c
                        )),
                        d && i.each(d, [c, b, a])
                    }
    ...
    f.extend({
        ...
        ajax: function (a, c) {
            ...
            d.crossDomain == null && (
                ...
                d.crossDomain = !(!r || r[1] == bV[1] && r[2] == bV[2] && (r[3] || (
                    r[1] === "http:"
                        ? 80
                        : 443
                )) == (bV[3] || (
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
        var e = typeof b.data == "string" && /^application\/x\-www\-form\-urlencoded/.test(
            b.contentType
        );
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (cd.test(b.url) || e && cd.test(b.data))) {
            ...
            b.jsonp !== !1 && (
                j = j.replace(cd, l),
                b.url === j && (e && (k = k.replace(cd, l)), b.data === k && (j += (
                    /\?/.test(j)
                        ? "&"
                        : "?"
                ) + b.jsonp + "=" + h))
    ...
    f.fx.prototype = {
        ...
        custom: function (a, c, d) {
            ...
            h() && f
                .timers
                .push(h) && !co && (co = setInterval(g.tick, g.interval))
        },
        show: function () {
            var a = f._data(this.elem, "fxshow" + this.prop);
            this
                .options
                .orig[this.prop] = a || f.style(this.elem, this.prop),
            this.options.show = !0,
            a !== b
        ...
        hide: function () {
            this
                .options
                .orig[this.prop] = f._data(this.elem, "fxshow" + this.prop) || f.style(
                    this.elem,
                    this.prop
                ),
            this.options.hide = !0,
