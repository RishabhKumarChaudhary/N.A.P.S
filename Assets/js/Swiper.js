...
!function (e, t) {
    ...
    var t = {
        ...
        styles: function () {
            return this[0]
                ? B.getComputedStyle(this[0], null)
                : {}
        }
    };
    Object
                        ...
                        if ("auto" === t.slidesPerView) {
                            ...
                            E = e.isHorizontal()
                                ? k[0]
                                    ...
                                    .width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(
                                        I.getPropertyValue("margin-right")
                                    )
                                : k[0]
                                    .getBoundingClientRect()
                                    .height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(
            ...
            if (0 !== i.length) {
                ...
                for (var n = 0; n < i.length; n += 1) {
                    ...
                    if (a.watchSlidesVisibility) {
                        ...
                        (0 <= d && d < t.size || 0 < p && p <= t.size || d <= 0 && p >= t.size) && i
                            .eq(
                                n
                            )
    ...
    var b = {
        attachEvents: function () {
            ...
            if (Y.touch || !Y.pointerEvents && !Y.prefixedPointerEvents) {
                if (Y.touch) {
                    var o = !(
                        "touchstart" !== a.start || !Y.passiveListener || !t.passiveListeners
                    ) && {
                        passive: !0,
                        capture: !1
                    };
        ...
        detachEvents: function () {
            ...
            if (Y.touch || !Y.pointerEvents && !Y.prefixedPointerEvents) {
                if (Y.touch) {
                    var o = !(
                        "onTouchStart" !== a.start || !Y.passiveListener || !t.passiveListeners
                    ) && {
                        passive: !0,
                        capture: !1
                    };
        ...
        E = {
            ...
            classes: {
                addClasses: function () {
                    ...
                    m.ios && s.push("ios"),
                    I.isIE && (Y.pointerEvents || Y.prefixedPointerEvents) && s.push(
                        "wp8-" + a.direction
                    ),
    ...
    var G = {
        ...
        W = {
            ...
            enable: function () {
                ...
                if (!t.enabled) {
                    t.enabled = !0;
                    var a = !(
                        "touchstart" !== e.touchEvents.start || !Y.passiveListener || !e.params.passiveListeners
                    ) && {
                        passive: !0,
                        capture: !1
                    };
        ...
        U = {
            ...
            destroy: function () {
                this.params.history.replaceState || B.removeEventListener(
                    "popstate",
        ...
        _ = {
            ...
            init: function () {
                ...
                if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                    ...
                    e.params.hashNavigation.watchState && L(B).on(
                        "hashchange",
            ...
            destroy: function () {
                this.params.hashNavigation.watchState && L(B).off(
                    "hashchange",
            ...
            setTranslate: function () {
                ...
                for (var h = 0; h < s.length; h += 1) {
                    ...
                    if (
                        ...
                        0 === T.length && (T = L('<div class="swiper-slide-shadow-' + (
                            p
                                ? "left"
                                : "top"
                        ) + '"></div>'), v.append(T)),
        ...
        te = {
            setTranslate: function () {
                for (
                    ...
                    Math.abs(g) < .001 && (g = 0),
                    Math.abs(b) < .001 && (b = 0);
                    var E = "translate3d(" + x + "px," + y + "px," + w + "px)  rotateX(" + b + "deg" +
                            ") rotateY(" + g + "deg)";
                    if (
                        v.transform(E),
                ...
                on: {
                    ...
                    click: function (e) {
                        var t = this.navigation,
                            a = t.$nextEl,
                            i = t.$prevEl;
                        !this.params.navigation.hideOnClick || L(e.target).is(i) || L(e.target).is(a) || (
                ...
                on: {
                    ...
                    click: function (e) {
                        ...
                        t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !L(
                            e.target
                        ).hasClass(t.params.pagination.bulletClass) && t
                            .pagination
                            .$el
